                ...
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {portfolioData.certificates.map((cert, index) => (
                            <div
                                key={index}
                                className={`relative glass-card overflow-hidden rounded-2xl p-6 transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_0_40px_rgba(34,211,238,0.8),0_0_80px_rgba(255,255,255,0.5)] border border-transparent hover:border-cyan-400 hover:bg-cyan-900/30`}
                            >
